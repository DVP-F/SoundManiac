...
file_path_out = os.path.join(file_path.removesuffix(os.path.basename(file_path)), 'tmp' if file_path.startswith(f'.{'/' if os.name != 'nt' else '\\'}tmp') else '', os.path.basename(file_path))
